...
def get_config():
    ...
    sample.batch_size = 1
    # number of batches to sample per epoch. the total number of samples per epoch is 
    ...
    # number of gradient accumulation steps. the effective batch size is 
    ...
    config.ll_ir = ll_ir = ml_collections.ConfigDict()
    ll_ir.use_ll = False
    ll_ir.intrinsic_coef = 0.05


    config.ood_ir = ood_ir = ml_collections.ConfigDict()
    ood_ir.use_ood = False
    ood_ir.intrinsic_coef = 0.05

    config.rnd_ir = rnd_ir = ml_collections.ConfigDict()
    rnd_ir.use_rnd = True
    rnd_ir.rnd_loss_weight = 1e-4
    rnd_ir.in_ch = 4
    rnd_ir.feature_dim = 512
    rnd_ir.intrinsic_coef = 0.05
    rnd_ir.learning_rate = 3e-4
    rnd_ir.adam_beta1 = 0.9
    rnd_ir.adam_beta2 = 0.999
    rnd_ir.adam_weight_decay = 1e-4
    rnd_ir.adam_epsilon = 1e-8
    rnd_ir.max_grad_norm = 1.0
    rnd_ir.add_to_last_state = False

    if rnd_ir.use_rnd or ll_ir.use_ll or ood_ir.use_ood:
    ...
    config.sample_path = "/home/sujin/project/ddpo-explore/saved_samples" # 
